...
class ActivityViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func updateArrayMenuOptions(){
        ...
        arrayMenuOptions.append(["title":"QR", "icon":"qrgenerator"])
        arrayMenuOptions.append(["title":"Wallet", "icon":"qrgenerator"])
        arrayMenuOptions.append(["title":"Currency", "icon":"qrgenerator"])
